...
import com.astrotalk.sdk.api.adapter.NewSearchPlaceAdapter;
import com.astrotalk.sdk.api.googleApi.GoogleAddressModel;
import com.astrotalk.sdk.api.utils.Constants;
import com.astrotalk.sdk.api.utils.DividerItemDecoration;
...
public class NewAstrotalkSearchActivity extends AppCompatActivity implements NewSearchPlaceAdapter.LocationItemClick {
    ...
    private NewSearchPlaceAdapter locationAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.at_activity_search_location_matchmaking);

        requestQueue = Volley.newRequestQueue(context);
        no_result = findViewById(R.id.no_result);
        searchsecound = findViewById(R.id.searchsecound);
        sharedPreferences = getSharedPreferences(Constants.USER_DETAIL, 0);
        ...
        linearLayoutManager = new WrapContentLinearLayoutManager(NewAstrotalkSearchActivity.this);
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recycler_view.setLayoutManager(linearLayoutManager);
        locationAdapter = new NewSearchPlaceAdapter(NewAstrotalkSearchActivity.this, userAddressArrayList, NewAstrotalkSearchActivity.this);
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(NewAstrotalkSearchActivity.this, drawable, 50);
    ...
    private void opensearchDialog() {
        ...
        final Dialog location_dialog = new Dialog(NewAstrotalkSearchActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        ...
        try {
            ...
            WrapContentLinearLayoutManager linearLayoutManager = new WrapContentLinearLayoutManager(NewAstrotalkSearchActivity.this);
            linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        ...
        imv_search.setOnClickListener(v -> {
            ...
            no_data_found_Rl.setVisibility(View.GONE);
            String url;
            url = Constants.ALL_LOCATION_AUTOCOMPLETE +
    ...
    private void requestLocation(CharSequence s) {
        ...
        locationAdapter.notifyDataSetChanged();
        String url;
        url = Constants.ASTROTALK_PLACE_SEARCH_API +
                "?limit=" + 15 +
                "&key=" + s;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
