...
public class NewSearchPlaceAdapter extends RecyclerView.Adapter<NewSearchPlaceAdapter.ViewHolder> {

    Context context;
    ArrayList<GoogleAddressModel> locationResultList;
    private final NewSearchPlaceAdapter.LocationItemClick locationItemClick;

    public NewSearchPlaceAdapter(Context context, ArrayList<GoogleAddressModel> locationResultList,
                                 NewSearchPlaceAdapter.LocationItemClick locationItemClick
    ) {
    ...
    @NonNull
    @Override
    public NewSearchPlaceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.at_matchmaking_location_adapter, parent, false);
        return new NewSearchPlaceAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewSearchPlaceAdapter.ViewHolder holder, int position) {
